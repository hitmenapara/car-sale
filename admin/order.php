...
<body style="background-image:url(img/rolls_royce.jpg); background-attachment: fixed;">
    ...
    <label><h1 align="center"> Order Car</h1></label>
<?php
session_start();
...
while($row = mysqli_fetch_row($res))
{
	...
	echo"<td><a href='deleteorder.php?id=$row[0]' onclick='javascript:return confirm(\"do you want to delete this record?\")'>DELETE</a></td></tr>";
}
}
else
{
